...
const config: LandingPageConfig = {
  ...
  hero: {
    badge: "For full version history",
    titleMaxWidth: 760,
  ...
  features: {
    ...
    sub: `Standard S3 versioning API. Versions billed at ${PRICE_PER_TB_SHORT} like any stored object, with no retrieval fee on any read.`,
    items: [
      {
        icon: Database,
