...
const config: LandingPageConfig = {
  ...
  hero: {
    ...
    description: `S3-compatible object storage built on Filecoin infrastructure. No egress, no lock-in, and your existing tools connect today. ${PRICE_PER_TB_SHORT} flat.`,
    ctas: [
