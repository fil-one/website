...
const TermsOfUse = () => {
  useSeo({
    ...
    canonical: "https://www.fil.one/terms",
  });

  return (
    <LegalPage title="Terms of Use" meta="Effective Date: Mar 3, 2026">
      <LegalP>
      ...
      <LegalSection title="Prohibited Conduct">
        ...
        <LegalList>
          <li>Engage in unauthorized spidering, &ldquo;scraping,&rdquo; or harvesting of content or personal information, or use any other unauthorized automated means to compile information.</li>
          <li>Take any action that imposes an unreasonable or disproportionately large load on our network or infrastructure.</li>
          <li>Use any device, software, or routine to interfere or attempt to interfere with the proper working of the Website or any activity conducted on the Website.</li>
          <li>Attempt to probe, scan, test the vulnerability of, or breach the security of any system or network.</li>
          ...
          <li>Engage in any other conduct that restricts or inhibits any person from using or enjoying the Website, or that, in our sole judgment, exposes us or any of our users, affiliates, or any other third party to any liability, damages, or detriment of any type.</li>
        </LegalList>
        <LegalP>
      ...
      <LegalSection title="Intellectual Property">
        ...
        <LegalList>
          <li>All information, data, software, text, displays, and visual interfaces, graphics, images, video, and audio, and all other elements of the Website, and the design, selection, and arrangement thereof.</li>
          <li>All intellectual property and other legal rights (including, but not limited to, any and all copyrights, patents, patent applications, trade secrets, trademarks, and other intangible rights) therein.</li>
        </LegalList>
        <LegalP>
      ...
      <LegalSection title="Links to Third-Party Content">
        <LegalP>
      ...
      <LegalSection title="Communications with You">
        <LegalP>
        ...
        <LegalList>
          <li>Solicit feedback via e-mail, surveys, bug reports, or other methods we may determine.</li>
          <li>Collect additional information regarding issues you report in your feedback.</li>
          <li>Notify you of changes to the Website, our products, or services, or these Terms.</li>
          <li>Tell you about our programs, products, or services.</li>
        </LegalList>
      </LegalSection>

      <LegalSection title="Disclaimer of Warranties; Limitation of Liability">
        <LegalP>
      ...
      <LegalSection title="Choice of Law and Forum">
        <LegalP>
