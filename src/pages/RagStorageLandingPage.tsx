...
// AWS S3 Standard eu-west-1 Q2 2026: storage 1,024 GB x $0.023 = $23.55,
// egress 5,120 GB x $0.09 = $460.80. Total $484.35.
// Fil One: 1 TB x PRICE_PER_TB, egress $0.
const config: LandingPageConfig = {
  ...
  problem: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "A 1 TB corpus read 5 times a month for batch retrieval incurs $460.80 in egress on AWS at $0.09/GB, on top of $23.55 in storage. The storage is the smaller charge. The reads are the bill.",
      },
      {
  ...
  comparison: {
    ...
    sub: "Any S3-compatible client reads and writes the document store. Retrieval reads are included in flat storage, with no egress counter.",
    subMaxWidth: 620,
    ...
    rows: [
      { provider: "AWS S3 Standard", values: { breakdown: "$23.55 storage + $460.80 egress", total: "$484/mo" } },
      {
        provider: "Fil One",
        isFilOne: true,
        values: { breakdown: `1 TB × ${PRICE_DISPLAY}, egress $0`, total: `${PRICE_DISPLAY}/mo` },
      },
    ],
    footnote:
      `AWS S3 Standard eu-west-1 Q2 2026: $0.023/GB storage, $0.09/GB egress. Computed from stated inputs: 1,024 GB × $0.023 = $23.55 storage; 5,120 GB × $0.09 = $460.80 egress. Fil One: 1 TB × ${PRICE_DISPLAY} = ${PRICE_DISPLAY}, egress $0.`,
  },
    ...
    items: [
      {
        ...
        desc: `At ${PRICE_PER_TB_SHORT} flat, a 1 TB document store is ${PRICE_DISPLAY}/month. A 10 TB corpus is ${usd2(10 * PRICE_PER_TB)}. The storage price does not penalize breadth.`,
      },
      {
        icon: ArrowsOut,
