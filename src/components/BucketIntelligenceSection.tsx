...
/**
 * Bucket Intelligence's own homepage section — a dark, visual-forward
 * spotlight (heading + description side by side, product screenshot below),
 * separate from Object Storage so a live, shipping product gets its own
 * moment instead of sharing a card grid.
 */
const BucketIntelligenceSection = () => {
  ...
  return (
    <section className="w-full bg-dark-section">
      <div className="flex flex-col gap-16 px-5 md:px-8 py-24 md:py-32 w-full max-w-container mx-auto">
        ...
        >
          <div className="flex flex-col gap-4 md:max-w-[380px]">
            ...
            <h2 className="m-0 font-display text-[32px] md:text-[44px] font-medium leading-[1.1] tracking-[-0.02em] text-white">
              Query your buckets<br />like a database
            </h2>
          </div>

          <div className="flex flex-col gap-4 md:max-w-[470px] md:pt-2">
            <p className="m-0 font-sans text-[15px] md:text-[16px] leading-[1.6] text-white/60">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 self-start font-sans text-[14px] font-medium text-white no-underline transition-opacity hover:opacity-70"
            >
              Learn more
        ...
        >
          <div className="flex flex-col items-center justify-center gap-3 w-full aspect-[16/9] rounded-2xl border-2 border-dashed border-white/15 bg-white/[0.03]">
            <Icon icon={ImageIcon} size={28} className="text-white/30" />
            <p className="m-0 font-mono text-[12px] uppercase tracking-[0.06em] text-white/30">
